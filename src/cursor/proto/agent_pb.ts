 ...
 */
export const TaskArgsSchema: GenMessage<TaskArgs> = /*@__PURE__*/ messageDesc(
  file_agent,
  40
);
 ...
 */
export const TaskErrorSchema: GenMessage<TaskError> = /*@__PURE__*/ messageDesc(
  file_agent,
  42
);
 ...
 */
export const ToolCallSchema: GenMessage<ToolCall> = /*@__PURE__*/ messageDesc(
  file_agent,
  46
);
 ...
 */
export const FileStateSchema: GenMessage<FileState> = /*@__PURE__*/ messageDesc(
  file_agent,
  78
);
 ...
 */
export type SummaryStartedUpdate =
  Message<"agent.v1.SummaryStartedUpdate"> & {};
...
export type AskQuestionArgs_Question =
  Message<"agent.v1.AskQuestionArgs_Question"> & {
    /**
...
export type AskQuestionArgs_Option =
  Message<"agent.v1.AskQuestionArgs_Option"> & {
    /**
     * stable option id
     *
     * @generated from field: string id = 1;
...
export type AskQuestionSuccess_Answer =
  Message<"agent.v1.AskQuestionSuccess_Answer"> & {
    /**
 ...
 */
export const KeyActionSchema: GenMessage<KeyAction> = /*@__PURE__*/ messageDesc(
  file_agent,
  164
);
...
export type CursorPositionAction =
  Message<"agent.v1.CursorPositionAction"> & {};
 ...
 */
export const PhaseSchema: GenMessage<Phase> = /*@__PURE__*/ messageDesc(
  file_agent,
  173
);
 ...
 */
export type CursorRuleTypeGlobal =
  Message<"agent.v1.CursorRuleTypeGlobal"> & {};
 ...
 */
export const EditArgsSchema: GenMessage<EditArgs> = /*@__PURE__*/ messageDesc(
  file_agent,
  204
);
 ...
 */
export const EditErrorSchema: GenMessage<EditError> = /*@__PURE__*/ messageDesc(
  file_agent,
  211
);
 ...
 */
export const ExaFetchArgsSchema: GenMessage<ExaFetchArgs> =
 ...
 */
export const ExaFetchResultSchema: GenMessage<ExaFetchResult> =
 ...
 */
export const ExaFetchSuccessSchema: GenMessage<ExaFetchSuccess> =
 ...
 */
export const ExaFetchErrorSchema: GenMessage<ExaFetchError> =
 ...
 */
export const ExaFetchRejectedSchema: GenMessage<ExaFetchRejected> =
 ...
 */
export const ExaFetchContentSchema: GenMessage<ExaFetchContent> =
 ...
 */
export const ExaFetchToolCallSchema: GenMessage<ExaFetchToolCall> =
 ...
 */
export type ExaFetchRequestResponse =
 ...
 */
export const ExaSearchArgsSchema: GenMessage<ExaSearchArgs> =
 ...
 */
export const ExaSearchResultSchema: GenMessage<ExaSearchResult> =
 ...
 */
export const ExaSearchSuccessSchema: GenMessage<ExaSearchSuccess> =
 ...
 */
export const ExaSearchErrorSchema: GenMessage<ExaSearchError> =
 ...
 */
export const ExaSearchRejectedSchema: GenMessage<ExaSearchRejected> =
 ...
 */
export const ExaSearchReferenceSchema: GenMessage<ExaSearchReference> =
 ...
 */
export const ExaSearchToolCallSchema: GenMessage<ExaSearchToolCall> =
  /*@__PURE__*/ messageDesc(file_agent, 231);

/**
 * @generated from message agent.v1.ExaSearchRequestQuery
 */
export type ExaSearchRequestQuery =
 ...
 */
export type ExaSearchRequestResponse =
  Message<"agent.v1.ExaSearchRequestResponse"> & {
    /**
 ...
 */
export const AbortArgsSchema: GenMessage<AbortArgs> = /*@__PURE__*/ messageDesc(
  file_agent,
  241
);
 ...
 */
export const FetchArgsSchema: GenMessage<FetchArgs> = /*@__PURE__*/ messageDesc(
  file_agent,
  245
);
 ...
 */
export const GrepArgsSchema: GenMessage<GrepArgs> = /*@__PURE__*/ messageDesc(
  file_agent,
  254
);
 ...
 */
export const GrepErrorSchema: GenMessage<GrepError> = /*@__PURE__*/ messageDesc(
  file_agent,
  256
);
 ...
 */
export const LsArgsSchema: GenMessage<LsArgs> = /*@__PURE__*/ messageDesc(
  file_agent,
  273
);
 ...
 */
export const LsResultSchema: GenMessage<LsResult> = /*@__PURE__*/ messageDesc(
  file_agent,
  274
);
 ...
 */
export const LsSuccessSchema: GenMessage<LsSuccess> = /*@__PURE__*/ messageDesc(
  file_agent,
  275
);
...
export type LsDirectoryTreeNode_File =
  Message<"agent.v1.LsDirectoryTreeNode_File"> & {
    /**
     * @generated from field: string name = 1;
     */
    name: string;
 ...
 */
export const LsErrorSchema: GenMessage<LsError> = /*@__PURE__*/ messageDesc(
  file_agent,
  278
);
 ...
 */
export const LsTimeoutSchema: GenMessage<LsTimeout> = /*@__PURE__*/ messageDesc(
  file_agent,
  280
);
...
export type TerminalMetadata_Command =
  Message<"agent.v1.TerminalMetadata_Command"> & {
    /**
     * @generated from field: string command = 1;
     */
    command: string;
 ...
 */
export const McpArgsSchema: GenMessage<McpArgs> = /*@__PURE__*/ messageDesc(
  file_agent,
  284
);
 ...
 */
export const McpResultSchema: GenMessage<McpResult> = /*@__PURE__*/ messageDesc(
  file_agent,
  285
);
 ...
 */
export const McpErrorSchema: GenMessage<McpError> = /*@__PURE__*/ messageDesc(
  file_agent,
  291
);
 ...
 */
export const McpToolsSchema: GenMessage<McpTools> = /*@__PURE__*/ messageDesc(
  file_agent,
  307
);
 ...
 */
export const ReadArgsSchema: GenMessage<ReadArgs> = /*@__PURE__*/ messageDesc(
  file_agent,
  312
);
 ...
 */
export const ReadErrorSchema: GenMessage<ReadError> = /*@__PURE__*/ messageDesc(
  file_agent,
  315
);
 ...
 */
export const ReadRangeSchema: GenMessage<ReadRange> = /*@__PURE__*/ messageDesc(
  file_agent,
  323
);
...
export type SelectedImage_Dimension =
  Message<"agent.v1.SelectedImage_Dimension"> & {
    /**
     * @generated from field: int32 width = 1;
     */
    width: number;
 ...
 */
export const CallFrameSchema: GenMessage<CallFrame> = /*@__PURE__*/ messageDesc(
  file_agent,
  368
);
...
export type InvocationContext_SlackThread =
  Message<"agent.v1.InvocationContext_SlackThread"> & {
    /**
...
export type InvocationContext_GithubPR =
  Message<"agent.v1.InvocationContext_GithubPR"> & {
    /**
     * @generated from field: string title = 1;
     */
    title: string;
...
export type InvocationContext_IdeState =
  Message<"agent.v1.InvocationContext_IdeState"> & {
    /**
 ...
 */
export const ShellArgsSchema: GenMessage<ShellArgs> = /*@__PURE__*/ messageDesc(
  file_agent,
  388
);
 ...
 */
export const TodoItemSchema: GenMessage<TodoItem> = /*@__PURE__*/ messageDesc(
  file_agent,
  424
);
 ...
 */
export const RangeSchema: GenMessage<Range> = /*@__PURE__*/ messageDesc(
  file_agent,
  435
);
 ...
 */
export const PositionSchema: GenMessage<Position> = /*@__PURE__*/ messageDesc(
  file_agent,
  436
);
 ...
 */
export const WriteArgsSchema: GenMessage<WriteArgs> = /*@__PURE__*/ messageDesc(
  file_agent,
  449
);
 ...
 */
export type BootstrapStatsigRequest =
  Message<"agent.v1.BootstrapStatsigRequest"> & {
    /**
 ...
 */
export const ExitEventSchema: GenMessage<ExitEvent> = /*@__PURE__*/ messageDesc(
  file_agent,
  462
);
...
export type ListArtifactsRequest =
  Message<"agent.v1.ListArtifactsRequest"> & {};
 ...
 */
export const McpOAuthStoredDataSchema: GenMessage<McpOAuthStoredData> =
 ...
 */
export const FrameSchema: GenMessage<Frame> = /*@__PURE__*/ messageDesc(
  file_agent,
  489
);
 ...
 */
export const BidiRequestIdSchema: GenMessage<BidiRequestId> =
 ...
 */
export const MouseButtonSchema: GenEnum<MouseButton> = /*@__PURE__*/ enumDesc(
  file_agent,
  1
);
 ...
 */
export const PackageTypeSchema: GenEnum<PackageType> = /*@__PURE__*/ enumDesc(
  file_agent,
  7
);
 ...
 */
export const TodoStatusSchema: GenEnum<TodoStatus> = /*@__PURE__*/ enumDesc(
  file_agent,
  12
);
 ...
 */
export const ClientOSSchema: GenEnum<ClientOS> = /*@__PURE__*/ enumDesc(
  file_agent,
  13
);
 ...
 */
export const Frame_KindSchema: GenEnum<Frame_Kind> = /*@__PURE__*/ enumDesc(
  file_agent,
  15
);
 ...
 */
export const ExecService: GenService<{}> = /*@__PURE__*/ serviceDesc(
  file_agent,
  2
);
